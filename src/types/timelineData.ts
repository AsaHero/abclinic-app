...
export const timelineData: TimelineEntry[] = [
  {
    ...
    title: "1936 год",
    description:
      "Начало пути. Первый Азимов в стоматологии. В 1936 году, сразу после окончания медтехникума, Исмоилжон Азимов стал единственным стоматологом посёлка Сырдарья, леча пациентов вручную на самодельной установке.",
    image: "/images/timeline/1936.jpg",
  },
  {
    year: 2018,
    title: "2018 год",
  ...
  },
  {
    ...
    title: "2022 год",
    description:
      "В 2022 году мы провели первый в истории клиники международный благотворительный проект: совместно с австралийскими хирургами-имплантологами мы устанавливали бесплатные имплантаты местному населению в течение недели.",
