...
const HowItWorksModal: React.FC<HowItWorksModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-[#002a27] border border-white/10 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div className="flex">
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-forest-500/20 flex items-center justify-center text-forest-400 flex-shrink-0">
              ...
              <div className="ml-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => {
                      onClose();
                      router.push("/services/consult-general");
                    }}
                    className="text-sm text-forest-400 hover:text-forest-300 underline"
                  >
                    Подробнее
                  </button>
                </div>
                <div className="flex items-center space-x-3 mb-3">
                  <span className="px-2 py-1 bg-forest-500/20 text-forest-300 rounded text-sm">200,000 сум</span>
                ...
                <div className="bg-white/5 rounded-lg p-3">
                  <ul className="space-y-1.5">
                    <li className="flex items-start">
                      <CheckCircle2 className="w-4 h-4 text-forest-400 mt-0.5 mr-2 flex-shrink-0" />
            ...
            <div className="flex">
              ...
              <div className="ml-6">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-medium text-white">Шаг 2: Диагностика и план лечения</h3>
                  <button
                    onClick={() => {
                      onClose();
                      router.push("/services/consult-diagnostic");
                    }}
                ...
                <div className="flex items-center space-x-3 mb-3">
                  <span className="px-2 py-1 bg-green-500/20 text-green-300 rounded text-sm">300,000 сум</span>
                  <div className="flex items-center text-gray-400 text-sm">
                    <Clock className="w-4 h-4 mr-1" />
                    <span>60-90 мин</span>
                  </div>
                ...
                <p className="text-gray-300 mb-3">Комплексное обследование и составление детального плана лечения.</p>
            ...
            <div className="flex">
              ...
              <div className="ml-6">
                ...
                <div className="flex items-center space-x-3 mb-3">
                  <span className="px-2 py-1 bg-purple-500/20 text-purple-300 rounded text-sm">Согласно плану</span>
                </div>
                <p className="text-gray-300 mb-3">Выполнение всех процедур согласно утвержденному плану лечения.</p>
                <div className="bg-white/5 rounded-lg p-3">
                  <ul className="space-y-1.5">
                    <li className="flex items-start">
          ...
          <div className="mt-8 border-t border-white/10 pt-6">
            <div className="bg-forest-500/10 border border-forest-500/20 rounded-lg p-4 mb-4">
              <p className="text-forest-200 text-sm text-center">
                💡 <strong>Экономия:</strong> Диагностика бесплатно при продолжении лечения в клинике
              </p>
            </div>
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              <button
                ...
                className="bg-gradient-to-r from-forest-500 to-forest-400 hover:from-forest-600 hover:to-forest-500 text-white font-medium px-6 py-3 rounded-lg inline-flex items-center justify-center transition-all"
              >
